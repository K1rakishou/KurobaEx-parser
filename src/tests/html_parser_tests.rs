...
mod test_main {
  ...
  fn html_parser_test_2() {
    ...
    let expected = r#"<s><a, class="linkify twitter", rel="noreferrer noopener", target="_blank", href="https://twitter.com/denonbu_eng/status/1388107521022468102">https://twitter.com/denonbu_eng/sta<wbr>tus/1388107521022468102 <a, class="embedder", href="javascript:;", data-key="Twitter", data-uid="denonbu_eng/status/1388107521022468102", data-options="undefined", data-href="https://twitter.com/denonbu_eng/status/1388107521022468102">(<span>unembed)"#;
    let actual = html_parser.debug_concat_into_string(&nodes);
